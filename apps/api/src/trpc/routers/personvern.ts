...
export const personvernRouter = router({
  /** Logg-policyen, lesbar for forhandleren. Åpenhet er en del av avtalen. */
  ...
  /** Hva leverandørene faktisk lagrer, og hva vi kan slette der. */
  vendorErasureFacts: protectedProcedure.query(() => vendorErasureFacts()),

  /**
   * Slett en kunde (art. 17), gjennom alle ledd.
