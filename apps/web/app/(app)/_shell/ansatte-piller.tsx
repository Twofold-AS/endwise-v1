...
export function AnsattePiller() {
  ...
  return (
    <SidePiller ariaLabel="Ansatte" piller={piller} aktivHref={aktiv ?? '/innstillinger/team'} />
  );
}
...
export function LagerPiller() {
  const pathname = usePathname() ?? '';
  const nav = useMekanikerNav() ? MEKANIKER_NAV : FORHANDLER_NAV;
