 ...
 * Mobbin 07.09.2026: geometri uendret (389 / 598 / 452). Tint-stige, ingen pip.
 ...
 * Nav boxes are full inner width (259), icon 20×20, label 16/20.
 * Enterprise box 233×52 pad-x 32, label 18. Profile 259 pad 12.
 * Logo 40px. Hjem-kort 300×140. Ronny i boks 3.
...
export const DESKTOP_NAV_IKON = 20;
export const DESKTOP_NAV_BTN_W = 259;
export const DESKTOP_NAV_BTN_H = 50;
export const DESKTOP_NAV_BTN_PAD = 12;
export const DESKTOP_NAV_LABEL_H = 20;
export const DESKTOP_NAV_LABEL_SIZE = 16;
...
export const DESKTOP_ENTERPRISE_LABEL = 18;
export const DESKTOP_LOGO_H = 40;
...
export const DESKTOP_KORT_W = 300;
export const DESKTOP_KORT_H = 140;
export const DESKTOP_KORT_PX = 12;
export const DESKTOP_KORT_PY = 16;
