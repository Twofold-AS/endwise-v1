...
export function PhoneTemaRad() {
  ...
  return (
    <div data-phone-profil-tema className="flex items-center justify-between gap-3 px-3 py-1">
      <span className="text-[17px] font-[700] leading-none text-fg">Modus</span>
      <div
