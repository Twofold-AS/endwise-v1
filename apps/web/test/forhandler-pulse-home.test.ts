...
describe('forhandler pulse-hjem — fem flater', () => {
  ...
  it('spark er denne uken (7 dager), ellers plausibel serie — aldri For lite data', () => {
    const naa = new Date('2026-08-29T10:00:00');
    ...
    const serie = siste7dSpark(
      [
        ...
        { id: '2', status: 'completed', startsAt: '2026-08-25T08:00:00' },
  ...
  it('ansatte på jobb er aktiv tildeling, ikke timeføring/status-humor', () => {
    const naa = new Date('2026-08-29T10:00:00');
        ...
        [
          {
            ...
            endsAt: '2026-08-29T12:00:00',
          },
        ],
        naa,
      ),
    ).toEqual({ paJobb: 1, totalt: 4 });
    expect(
      ansattePulse(
        [{ id: '2', status: 'ledig' }],
        [
