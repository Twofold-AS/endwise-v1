...
> ### ⚠️ CODE-GO innbygging PR1 (15.09.2026)
> I dag-kortet: stille tekstlenke «Endringer» nederst (`PulseEndringerLenke`,
> `text-label` + hale-pil) → `/jobber?fane=endringer`. Ikke hero-CTA, ikke
> `#0066ff`. Chrome urørt. Avvik/Forespørsel-tall på samme bunn-rad. Ingen ny
> pakke. ⛔ #114/#119. ⛔ nye dest-piller.
