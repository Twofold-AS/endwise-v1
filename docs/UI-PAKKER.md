...
> Åpen (peek/full): fast ugjennomsiktig flate under chrome (pergament +
> Grainient) — siden bak er skjult og `overflow-hidden`. Peek-kort kan
> være Verksted-bredde; backdrop dekker resten. Full = viewport-grainient.
> Composer-bakgrunn er **full viewport-bredde**. Håndtak over input.
