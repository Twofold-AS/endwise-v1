...
> resolusjonskontekst, samme felle som `motion`/`recharts`). Lys palett er `#ffffff` / `#ededed` /
> `#f5f5f5`; mørk er snippet-fargene `#777777` / `#333333` / `#111111`. Ikke vask siden hvit.
