...
> ### ⚠️ Grainient er KUN stripe/peek; Galaxy er Oppgrader + Ronny full-åpen (03.09.2026)
...
> og peek/logg-rammen under stripen. Idle/peek-composer nederst
...
> synlig. Full: **Galaxy** på mørk `#111` (`density={2.5}`, tettere enn
> Oppgrader `density={1}`) — prompt uten eget WebGL. ⛔ Ikke Galaxy på
...
| **Oppgrader-CTA + Ronny full** | Galaxy (`ogl`) | React Bits Galaxy: oval Oppgrader-knapp (`density={1}`, `#111`) og Ronny full-åpen (`density={2.5}`, `#111`). Ikke Grainient. Ikke dealer-pergament. |
