...
| Workshop-stripe (`_workshop/workshop-bloub.tsx` + `grainient.tsx`, 01.09.2026 kveld) | **Grainient** (§1). Telefon ~44px, desktop 32px. Hvit KI-Ronny midtstilt. **02.09.2026 (Mikael IA A):** lukket = radius 0. Åpen = Grainient-kort 18px, dashboard-px, Prompt animerer inn. Liten sirkel (`size-6`) bare før første fold. Ingen hvit pille rundt «Spør Ronny». **02.09.2026 (Mikael t648):** kompakt Prompt Input (1–2 linjer, submit på rad). Første send folder hele boksen til fast samtalehøyde; flere meldinger scroller over prompt (`no-scrollbar`). **02.09.2026 (Mikael t646+t647):** overlay over dest-bar. `RonnyPil` fra `chevron-down.svg`. Idle 2.5s. Submit `#0066cc`. ⛔ Model-picker, globe, vedlegg, bunndock, lucide-piler. |
