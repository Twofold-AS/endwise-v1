...
> aktivt ikon, hårlinje over vilkår, vilkår 14/550. Popup-topp = dest-pille-topp
...
| **Lisens** | MIT |
| **Hentet inn** | `DitherStackedChart` · `DitherGrowthChart` · `RevenueLineChart` · `DitherDonutChart` + `useCanvasSetup`. **08.09:** `DitherDonutChart` compact som mini-boble denne vs forrige måned på forhandler-toppkort (F3-05). Amicro har ingen egen bubble — donut er den sirkulære sammenligningen. **07.09:** `DitherGrowthChart` compact var 7d-spark (fjernet 08.09). |
