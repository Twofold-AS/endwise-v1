...
> Galaxy forblir Oppgrader-CTA. Se `docs/endwise-dealer-chrome-sheet-fasit.md`.
...
| `RonnyHandtak` (`_workshop/ronny-ikoner.tsx`) | **Ingen ny pakke.** Horisontal strek (iOS-grabber), ~36×5 muted capsule over sheet-header. Swipe ned lukker, tydelig swipe opp → 100 %. shadcn/vaul Sheet er ikke hentet. |
