...
| Auth-feltene (`apps/web/app/_auth/felter.tsx`: `Field`, `INPUT`) + `AuthMerke` | **Ingen ny pakke.** 08.09.2026 Mobbin: felt er `bg-inset` (`#f0f0f0` / mørk `#262626`), `rounded-[16px]`, `min-h-[52px]` padding sm/md, fokus tykk canvas/hvit ramme. `AuthMerke` er mask + `bg-fg` (synlig i mørkt). `packages/ui` sin `Input` er `h-10`/`rounded-md` — feil mål. |
