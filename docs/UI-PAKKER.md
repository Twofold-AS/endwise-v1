...
> animert bakgrunn på workshop-stripen (telefon ~44px, desktop `h-control` / 32px).
...
| **Bakgrunn (AI-stripe)** | Grainient (`ogl`) | KI-Ronny-stripe: 44px telefon / 32px desktop. ShaderGradient er ute. Ikke dealer-hero. |
