...
> peek/logg-rammen under stripen, **og** idle/peek-composer nederst
> (`fixed inset-x-0 bottom-0`, full viewport-bredde, `rounded-none` mot
> skjermkant; safe-area er padding *inne* i baren). Idle-stripe er
...
> strek **under boblen**, prompt-bar full-bleed med eget Grainient, siden
