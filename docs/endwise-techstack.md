...
- **Galaxy** (react-bits Galaxy-JS-CSS + `ogl`) — Oppgrader-CTA i sidebaren (`density={1}`, `#111`). ⛔ Ikke Ronny (stripe/peek/full). ⛔ Ikke 1080-side. ⛔ Ikke dealer-pergament. ⛔ Ikke Grainient på Oppgrader. Detaljer i `docs/UI-PAKKER.md`
