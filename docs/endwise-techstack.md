...
- **Galaxy** (react-bits Galaxy-JS-CSS + `ogl`) — Oppgrader-CTA i sidebaren (`density={1}`, `#111`) og Ronny full-åpen chat-flate (`density={2.5}`, `#111`). Samme komponent. ⛔ Ikke 1080-side. ⛔ Ikke dealer-pergament. ⛔ Ikke Grainient på Oppgrader. Detaljer i `docs/UI-PAKKER.md`
