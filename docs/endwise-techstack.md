...
- **ShaderGradient** (`@shadergradient/react` 2.4.20 + `@react-three/fiber` ^9 + `three`) — workshop-stripe øverst i innholdskolonnen (01.09.2026). ⛔ Grainient/`ogl` slettet. Detaljer i `docs/UI-PAKKER.md`
