...
- **Grainient** (react-bits Grainient-JS-CSS + `ogl` ^1.0.11) — 32px workshop-stripe (01.09.2026 kveld). ⛔ ShaderGradient ute. ⛔ Ikke dealer-hero. Detaljer i `docs/UI-PAKKER.md`
