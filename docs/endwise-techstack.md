...
- **Grainient** (react-bits Grainient-JS-CSS + `ogl` ^1.0.11) — komponenten ligger i `@endwise/ui`, men er **ikke** på Ronny-stripe/peek/composer (03.09.2026). ⛔ ShaderGradient ute. ⛔ Ikke dealer-hero. Detaljer i `docs/UI-PAKKER.md`
...
- **Galaxy** (react-bits Galaxy-JS-CSS + `ogl`) — Oppgrader-CTA i sidebaren (`density={1}`, `#111`) og Ronny-stripe + peek + full-åpen (`density={2.5}`, `#111`). Samme komponent. ⛔ Ikke 1080-side. ⛔ Ikke dealer-pergament. ⛔ Ikke Grainient på Ronny eller Oppgrader. Detaljer i `docs/UI-PAKKER.md`
