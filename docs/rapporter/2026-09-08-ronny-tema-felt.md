...
- **F5-13:** Profilmeny-skiller er `.ew-haarlinje` (`--ew-border-strong`) — synlig i mørkt. Vilkår 16/650.
...
- `h-px bg-border` i profilmenyen forsvant i mørkt fordi `--ew-border` = `--ew-surface` (`#262626`).
