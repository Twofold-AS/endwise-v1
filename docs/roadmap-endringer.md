...
**Godkjent av:** Mikael CODE-GO korreksjon etter #157.
**Endring:** **F3-05** `done` (korreksjon). Toppkort-spark er Amicro `DitherGrowthChart` linje/growth (forrige → denne), ikke donut. Ikonplater alltid `#ffffff`. + Jobb én linje. Innboks kun meldingstall. Større ikoner. Fortsatt kun fem flater. ⛔ Ronny/profil. ⛔ #114/#119. Squash-merge #159.
...
**Endring:** **F5-13** `progress`. `.ew-haarlinje` på `--ew-fg-faint` (#adadad/#707070) — `--ew-border-strong` var fortsatt usynlig mot surface. Vilkår 17/700. Ronny-tema + `.ew-felt` uendret. ⛔ #114/#119. Squash-merge #158.
...
**Endring:** **F5-13** `progress`, **F5-10** note. Ronny `.ink-invert` (hvit på mørkt). Sheet `bg-surface text-fg`. Standardfelt `.ew-felt` overalt. ⛔ #114/#119. Squash-merge #158.
...
**Godkjent av:** Mikael CODE-GO (phone chrome lock — superseder overlay/toggle/hjem-kort-only).
**Endring:** **F5-13** done (telefon: sidebar skjult; top-bar 1 merke+søk+Ronny+profil; top-bar 2 dest-piller; hårlinje; Mobbin-kort 24px). **F5-01** note (telefon-overlay borte). Desktop 389/598/452 urørt. Mobbin-fargelås urørt. ⛔ nye destinasjoner. ⛔ #114/#119.
