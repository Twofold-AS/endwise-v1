...
**Godkjent av:** Jonas-fasit 05.09.2026 (`endwise-landing-fasit.md`). Mikael hoppet over H1/CTA-widget — Jonas-default brukt.
**Endring:** **F5-35** forblir `done`. `/` byttet fra nøktern 720px-side til Apple-markedsflate: H1 «Verkstedet, samlet.», CTA `#111`, tre løfter, desktop+Min dag, TIERS-pris 4490/8490/12490, tillit, footer. Nye ruter `/personvern` `/vilkar` `/kontakt`. Dealer-chrome urørt.
