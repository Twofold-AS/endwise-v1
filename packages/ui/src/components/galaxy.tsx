...
/**
 * React Bits Galaxy (JS+CSS). Bakgrunn inne i en knapp — ikke 1080-side.
 * Installert fra @react-bits/Galaxy-JS-CSS. Shader og props er oppstrøms.
 */
export function Galaxy({
  ...
  useEffect(() => {
    ...
    const targetMouseActive = { value: 0 };
    const smoothMouseActive = { value: 0 };
