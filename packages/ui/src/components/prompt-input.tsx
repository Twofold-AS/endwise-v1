...
export function PromptInputTextarea({
  ...
  return (
    <textarea
      ...
      className={cn(
        'field-sizing-content max-h-8 min-h-6 w-full resize-none bg-transparent px-2 py-1 text-[16px] text-fg outline-none placeholder:text-[16px] placeholder:text-fg-muted disabled:opacity-50 md:text-label md:placeholder:text-label',
        className,
      )}
      {...props}
    />
...
export function PromptInputSubmit({
  ...
  return (
    <button
      ...
      className={cn(
        'inline-flex size-7 shrink-0 items-center justify-center rounded-full bg-primary text-primary-foreground transition-opacity hover:opacity-90 disabled:opacity-40',
        className,
      )}
      {...props}
    >
